    ...
    return (
        <main className="max-w-[1500px] mx-auto px-6 pb-6">
            ...
            <div className="space-y-4">
                <div className="p-5 grid grid-cols-1 md:grid-cols-6 gap-4 shadow-md border border-gray-300 rounded-xl">
                    ...
                    <div className="col-span-1 md:col-span-3 ">
                        ...
                        <p className="mb-2"><strong>Total of Price:</strong> $200</p>
